...
public class ServicioPeliculasArchivo implements IServicioPeliculas {
    ...
    public ServicioPeliculasArchivo(){
        ...
        try{
            ...
            if(archivo.exists()) System.out.println("El archivo existe");
            else {
    ...
    public void listarPeliculas() {
        ...
        try{
            ...
            System.out.println("Ocurrio un error al leer un archivo: "+ e.getMessage());
        }
    }
    ...
    public void buscarPelicula(Pelicula pelicula) {
        ...
        try{
            // Abrimos el archivo para lectura LineaxLinea
            var entrada = new BufferedReader(new FileReader(archivo));
            String lineaTexto;
            ...
            while (lineaTexto != null){
                ...
                // Leemos la siguiente linea de la siguiente iteracion
                lineaTexto = entrada.readLine();
                indice++;
            }
